...
def annotate_image(input_file, output_file):
    ...
    annotated_image = annotate_image_array(cv2.imread(input_file))
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Lane Detection and Annotation")
    ...
    parser.add_argument("-I", "--image_only", action="store_true", dest="image_only", default=False,
