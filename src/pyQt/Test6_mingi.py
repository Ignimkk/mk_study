...
class WindowClass(QMainWindow, from_class): 
    def __init__(self):
        ...
        self.day_2.currentIndexChanged.connect(self.printBirthday2)
    ...
    def db(self, min_bir, max_bir):
        ...
        if not result:
            QMessageBox.warning(self, 'Warning', 'ㅎㅎ.')
            self.result.clear()
            self.result_2.clear()
            return None
        else:
