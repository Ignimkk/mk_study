...
def calibrate_camera(nx, ny, basepath):
    ...
    images = glob.glob(path.join(basepath, 'image_*_color.jpg'))          # <------------------ 수정
...
if __name__ == "__main__":
    ...
    nx, ny = 7, 4  # number of grids along x and y axis in the chessboard pattern             # <------------------------- 수정
    basepath = 'image/Grandeur/color/'  # path contain the calibration images              #<-----------------------수정
